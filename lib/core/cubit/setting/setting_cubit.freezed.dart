...
abstract class $SettingStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({String locale, bool onboarding});
}
...
class _$_SettingState implements _SettingState {
  const _$_SettingState({required this.locale, required this.onboarding});
  ...
  @override
  String toString() {
    return 'SettingState(locale: $locale, onboarding: $onboarding)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, locale, onboarding);
...
abstract class _SettingState implements SettingState {
  const factory _SettingState(
      ...
      required final bool onboarding}) = _$_SettingState;
